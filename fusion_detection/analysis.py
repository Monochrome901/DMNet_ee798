...
def visualize_comparison(json_file, img_folder, annot_folder, num_samples=5, output_folder=None):
    ...
    # Process a limited number of samples for visualization
    img_names = list(predicted_data.keys())[:num_samples]
...
# Example usage
json_file = "dataset/Global/val/final_fusion_result.json"  # Path to the final JSON file
img_folder = "dataset/Global/val/images"  # Folder containing the images
annot_folder = "dataset/Global/val/annotations"  # Folder containing the actual annotations
